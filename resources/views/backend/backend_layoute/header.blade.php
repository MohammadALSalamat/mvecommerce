        ...
        <ul class="flex-row nav navbar-nav">
          ...
          <li class="mr-auto nav-item">
            <a class="navbar-brand" href="index.html">
              ...
              <h3 class="brand-text">9Yards Admin</h3>
            </a>
          </li>
          <li class="float-right nav-item d-none d-md-block"><a class="pr-0 nav-link modern-nav-toggle" data-toggle="collapse"><i class="toggle-icon ft-toggle-right font-medium-3 white" data-ticon="ft-toggle-right"></i></a></li>
          ...
          <ul class="float-left mr-auto nav navbar-nav">
            ...
            <li class="dropdown nav-item mega-dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown">Mega</a>
              <ul class="mega-dropdown-menu dropdown-menu row">
                <li class="col-md-2">
                  <h6 class="mb-1 dropdown-menu-header text-uppercase"><i class="la la-newspaper-o"></i> News</h6>
                  <div id="mega-menu-carousel-example">
                    <div>
                      <img class="mb-1 rounded img-fluid" src="{{ asset('app-assets/images/slider/slider-2.png') }}"
                      alt="First slide"><a class="mb-0 news-title" href="#">Poster Frame PSD</a>
                ...
                <li class="col-md-3">
                  ...
                  <div id="accordionWrap" role="tablist" aria-multiselectable="true">
                    <div class="border-0 card box-shadow-0 collapse-icon accordion-icon-rotate">
                      <div class="p-0 pb-2 border-0 card-header" id="headingOne" role="tab"><a data-toggle="collapse" data-parent="#accordionWrap" href="#accordionOne"
                      ...
                      <div class="p-0 pb-2 border-0 card-header" id="headingTwo" role="tab"><a class="collapsed" data-toggle="collapse" data-parent="#accordionWrap"
                      ...
                      <div class="p-0 pb-2 border-0 card-header" id="headingThree" role="tab"><a class="collapsed" data-toggle="collapse" data-parent="#accordionWrap"
                ...
                <li class="col-md-4">
                  <h6 class="mb-1 dropdown-menu-header text-uppercase"><i class="la la-envelope-o"></i> Contact Us</h6>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <div class="position-relative has-icon-left">
                            ...
                            <div class="pl-1 form-control-position"><i class="la la-user"></i></div>
                          </div>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <div class="position-relative has-icon-left">
                            ...
                            <div class="pl-1 form-control-position"><i class="la la-envelope-o"></i></div>
                          </div>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <div class="position-relative has-icon-left">
                            ...
                            <div class="pl-1 form-control-position"><i class="la la-commenting-o"></i></div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="mb-1 col-sm-12">
                          <button class="float-right btn btn-info" type="button"><i class="la la-paper-plane-o"></i> Send </button>
                        </div>
                      </div>
                    </div>
                  </form>
          ...
          <ul class="float-right nav navbar-nav">
            ...
            <li class="dropdown dropdown-notification nav-item">
              ...
              <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                ...
                <li class="dropdown-menu-footer"><a class="text-center dropdown-item text-muted" href="javascript:void(0)">Read all messages</a></li>
              </ul>
            </li>
          </ul>
        </div>
