    ...
    <div class="content-header row">
      ...
      <div class="content-header-right col-md-6 col-12">
        <div class=" float-md-right">
          <a href="{{ route('createproducts') }}"><button class="px-2 btn btn-primary round btn-glow" type="button" ><i class="la la-plus"></i> Add product </button></a>
        </div>
      </div>
    </div>
                ...
                <div class="card-body card-dashboard">
                  ...
                  <table class="table table-striped table-bordered file-export">
                    ...
                    <tbody>
                        ...
                        <td>
                              <span class="dropdown">
                                ...
                                <span aria-labelledby="btnSearchDrop2" class="mt-1 dropdown-menu dropdown-menu-right">
                                  <a href="{{ route('editproducts',$product->id) }}" class="dropdown-item"><i class="ft-edit-2"></i> Edit</a>
                              ...
                              @csrf
                                  ...
                                  <a href="javascript:void(0)" data-toggle="modal" data-target="#product{{ $product->id }}" class="dropdown-item"><i class="ft-plus-circle primary"></i> View More</a>
                      ...
                      <!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="product{{ $product->id }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      $Child_Category_Title = \App\Models\category::where('id',$product->child_category_id)->first();
     ...
     <div class="row">
         <div class="col-6">
            <b>Size : </b>
        <p><div class='badge badge-success'>{{ $product->size }}</div></p>
         </div>
         <div class="col-6">
            <b>Condation : </b>
        <p><div class='badge badge-success'>{{ $product->conditions }}</div></p>
        </div>
     </div>
       ...
       <div class="row">
        <div class="col-6">
           <b>Stock : </b>
           @if($product->stock > 10)
           <p><div class='badge badge-success'>{{ $product->stock }}</div></p>
            @else
            <p><div class='badge badge-danger'>{{ $product->stock }}</div></p>
           @endif
        </div>
        <div class="col-6">
           <b>Price : </b>
       <p><div class='badge badge-success'>{{ $product->price }} $</div></p>
       </div>
    </div>
      ...
      <div class="row">
        <div class="col-6">
           <b>Offer Price : </b>
       <p><div class='badge badge-success'>{{ $product->offer_price }}</div></p>
        </div>
        <div class="col-6">
           <b>Discound : </b>
       <p><div class='badge badge-success'>{{ $product->discound }}%</div></p>
       </div>
    </div>
       <!-- summary section -->
