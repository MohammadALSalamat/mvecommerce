...
<!-- Magnific Popup -->
<link rel="stylesheet" type="text/css" href="{{ asset('documentaion/vendor/magnific-popup/magnific-popup.min.css') }}" />
<!-- Highlight Syntax -->
  ...
  <header id="header" class="sticky-top"> 
    ...
    <nav class="primary-menu navbar navbar-expand-lg navbar-dropdown-dark">
      <div class="container-fluid">
		...
		<!-- Logo --> 
        <a class="logo ml-md-3" href="index.html" title="iDocs Template"> <img src="{{ asset('documentaion/images/logo.png') }}" alt="iDocs Template"/> </a> 
