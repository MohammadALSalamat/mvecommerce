          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-content collpase show">
                <div class="card-body">
                  <form class="form form-horizontal" action="{{ route('seller_addproducts') }}" method="POST"
                    ...
                    <div class="form-body">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="projectinput5" class="form-control" placeholder="add the title"
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="projectinput5" class="form-control" placeholder="add the title"
                            name="ar_title" value="{{ old('ar_title') }}">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <textarea id="summernote" rows="5" class="form-control" name="summary"
                            placeholder="About Project">{{ old('summary') }}</textarea>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-md-3 label-control" for="projectinput11">Arabic Summary</label>
                        <div class="col-md-9">
                          <textarea id="summernote_ar1" rows="5" class="form-control" name="ar_summary"
                            placeholder="About Project">{{ old('ar_summary') }}</textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <textarea id="summernote1" rows="5" class="form-control" name="comment"
                            placeholder="About Project">{{ old('description') }}</textarea>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-md-3 label-control" for="projectinput9">Arabic Description</label>
                        <div class="col-md-9">
                          <textarea id="summernote_ar" rows="5" class="form-control" name="ar_comment"
                            placeholder="About Project">{{ old('ar_description') }}</textarea>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-md-3 label-control" for="projectinput9">Additional Info</label>
                        <div class="col-md-9">
                          <textarea id="summernote2" rows="5" class="form-control" name="additional_info"
                            placeholder="write somthing new">{{ old('additional_info') }}</textarea>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-md-3 label-control" for="projectinput9">Arabic Additional Info</label>
                        <div class="col-md-9">
                          <textarea id="summernote_ar2" rows="5" class="form-control" name="ar_additional_info"
                            placeholder="write somthing new">{{ old('ar_additional_info') }}</textarea>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-md-3 label-control" for="projectinput9">Return Policy</label>
                        <div class="col-md-9">
                          <textarea id="summernote3" rows="5" class="form-control" name="return_policy"
                            placeholder="Write Something ">{{ old('return_policy') }}</textarea>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-md-3 label-control" for="projectinput9">Arabic Return Policy</label>
                        <div class="col-md-9">
                          <textarea id="summernote_ar3" rows="5" class="form-control" name="ar_return_policy"
                            placeholder="Write Something ">{{ old('ar_return_policy') }}</textarea>
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="projectinput5" class="form-control"
                            placeholder="add the sku for the product" name="sku" value="{{ old('sku') }}">
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="number" id="projectinput31" class="form-control"
                            placeholder="Add The Offer Price Value" step="any" name="offer_price"
                            value="{{ old('price') }}">
                        </div>
                      </div>
                        ...
                        <div class="col-md-9">
                          ...
                          <label class="switch">
                            <input type="checkbox" name="status"
                              vlaue="{{ old('status') == "active" ? 'selected' : ''}}">
  ...
  function MultiselectDropdown(options) {
    ...
    function newEl(tag, attrs) {
      ...
      if (attrs !== undefined) Object.keys(attrs).forEach(k => {
        if (k === 'class') {
          Array.isArray(attrs[k]) ? attrs[k].forEach(o => o !== '' ? e.classList.add(o) : 0) : (attrs[k] !== '' ? e
            .classList.add(attrs[k]) : 0)
        } else if (k === 'style') {
