                                            ...
                                            <div class="form-group row">
                                              ...
                                              <div class="col-md-9">
                                                  <input type="text" id="projectinput1000" class="form-control"
                                                      placeholder="add the SKU value" name="sku" value="{{ old('sku') }}">
                                              </div>
                                          </div>
                                            <div class="form-group row">
...
<div class="app-content content">
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="mb-2 content-header-left col-md-6 col-12 breadcrumb-new">
                <h3 class="mb-0 content-header-title d-inline-block">اضافة منتجات</h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('seller_viewproducts') }}">الرئيسية</a>
                            </li>
            ...
            <section id="horizontal-form-layouts">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="horz-layout-basic">اضف منتج جديد</h4>
                                <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                                <div class="heading-elements">
                                    <ul class="mb-0 list-inline">
                                        <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal" action="{{ route('seller_addproducts') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="projectinput5">اسم المنتج بالعربي</label>
                                                <div class="col-md-9">
                                                    <input type="text" id="projectinput5" class="form-control"
                                                        placeholder="add the title" name="ar_title" value="{{ old('ar_title') }}">
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="projectinput56">اسم البائع</label>
                                                <div class="col-md-9">
                                                    <select id="projectinput56" name="vendor" class="form-control" disabled>
                                                        <option  selected value="{{ $vendors->id }}"> {{ $vendors->full_name }}
                                                        </option>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="cat_id">فئة المنتج</label>
                                                <div class="col-md-9">
                                                    <select id="cat_id" name="category" class="form-control">
                                                        <option value="none" ><-- Category -->
                                                        </option>
                                            ...
                                            <div class="form-group row d-none" id="child_cat_div">
                                                <label class="col-md-3 label-control" for="child_cat_id">الفئة الفرعية</label>
                                                <div class="col-md-9">
                                                    <select id="child_cat_id" name="child_category" class="form-control">
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="input-group col-md-10 offset-2">
                                                    <span class="input-group-btn">
                                                        <a id="lfm" data-input="thumbnail" data-preview="holder" class="btn btn-light">
                                                            <i class="fa fa-picture-o"></i> صورة المنتج
                                                        </a>
                                                    </span>
                                                    <input id="thumbnail" class="form-control" type="text" name="filepath">
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control"
                                                    for="projectinput9">سياسة الخصوصية</label>
                                                <div class="col-md-9">
                                                    <textarea id="summernote3" rows="5" class="form-control"
                                                        name="return_policy" placeholder="Write Something ">{{ old('return_policy') }}</textarea>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control"
                                                    for="projectinput9">سياسة الخصوصية بالعربي</label>
                                                <div class="col-md-9">
                                                    <textarea id="summernote_ar3" rows="5" class="form-control"
                                                        name="ar_return_policy" placeholder="Write Something ">{{ old('ar_return_policy') }}</textarea>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                              <label class="col-md-3 label-control" for="projectinput30">رقم المنتج التسلسلي</label>
                                              <div class="col-md-9">
                                                  <input type="text" id="projectinput1000" class="form-control"
                                                      placeholder="add the SKU value" name="sku" value="{{ old('sku') }}">
                                              </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="projectinput56">منتجات تباع معه</label>
                                                <div class="col-md-9">
                                                        <select name="field2[]" id="field2" multiple multiselect-search="true" multiselect-select-all="true" multiselect-max-items="3" >						    
                                                        @foreach ($products as $product)
                                                        <option  value="{{ $product->id }}" > {{ $product->title }}</option>
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <button type="submit" class="btn btn-primary">
                                                <i class="la la-check-square-o"></i> حفظ المنتج
                                            </button>
                                        </div>
                                    </form>
                                </div>
