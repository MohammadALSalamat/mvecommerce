...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('app-assets/vendors/css/extensions/jquery.toolbar.css') }}">
          ...
          <div id="invoice-template" class="card-body">
            ...
            <div id="invoice-company-details" class="row">
              <div class="col-md-6 col-sm-12 text-center text-md-left">
                <div class="media">
                  <img src="{{ url('front-style/assets/images/itajer_logo.png') }}" width="200px"
...
<script src="{{ url('app-assets/vendors/js/extensions/jquery.toolbar.min.js') }}" type="text/javascript"></script>
<script src="{{ url('app-assets/js/scripts/extensions/toolbar.js') }}" type="text/javascript"></script>
...
<script src="{{ url('app-assets/js/scripts/editors/editor-summernote.js') }}" type="text/javascript">
</script>  
