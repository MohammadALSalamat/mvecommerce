    ...
    <div class="content-header row">
      ...
      <div class="content-header-right col-md-6 col-12">
        <div class=" float-md-right">
          <a href="{{ route('createbanner') }}"><button class="px-2 btn btn-primary round btn-glow" type="button" ><i class="la la-plus"></i> Add Banner </button></a>
        </div>
      </div>
    </div>
                ...
                <div class="card-body card-dashboard">
                  ...
                  <table class="table table-striped table-bordered file-export">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>{{$banner->id }}</td>
                        <td><img src="{{asset($banner->image)  }}" width="100%" height="50px"
                            alt="{{ $banner->title }}"></th>
                        <td>{{ $banner->title }}</td>
                        <td>{{ $banner->slug }}</td>
                        <td> @if($banner->is_banner == '1')
                          <div class="badge badge-success">banner</div>
                          @else
                          <div class="badge badge-danger">ads</div>
                          @endif
                        </td>
