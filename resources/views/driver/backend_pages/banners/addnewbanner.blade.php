            ...
            <div class="mb-2 content-header-left col-md-6 col-12 breadcrumb-new">
                ...
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('bannersview') }}">Home</a>
                            </li>
                            <li class="breadcrumb-item active"><a href="#">Add Banners</a>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="horz-layout-basic">Add New Banner</h4>
                            ...
                            <div class="card-content collpase show">
                                <div class="card-body">
                                    ...
                                    <form class="form form-horizontal" action="{{ route('addbanner') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-body">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="projectinput1">Is It Banenr ?</label>
                                                <div class="col-md-9">
                                                   <!-- Rounded switch -->
                                                        <label class="switch">
                                                        <input type="checkbox" name="is_banner" vlaue="{{ old('status') == "active" ? 'checked' : ''}}">
