            ...
            <div class="mb-2 content-header-left col-md-6 col-12 breadcrumb-new">
                ...
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('viewproducts') }}">View Products</a>
                            </li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <form class="form form-horizontal"
                                    action="{{ route('create_productAttr',$current_product->id) }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div id="productAttr" style="overflow-x: scroll; padding-left:10px"
                                            ...
                                            <td>
                                                <span class="dropdown">
                                                    ...
                                                    <span aria-labelledby="btnSearchDrop2"
                                                        ...
                                                        <form action="{{ route('deletproductAttr',$attr->id) }}"
                                                            method="post">
                                                            @csrf
