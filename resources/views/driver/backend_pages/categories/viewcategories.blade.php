  ...
  <div class="content-wrapper">
    <div class="content-header row">
      <div class="mb-2 content-header-left col-md-6 col-12 breadcrumb-new">
        <h3 class="mb-0 content-header-title d-inline-block">View Categories</h3>
      ...
      <div class="content-header-right col-md-6 col-12">
        <div class=" float-md-right">
          <a href="{{ route('createcategories') }}"><button class="px-2 btn btn-primary round btn-glow" type="button"><i
                class="la la-plus"></i> Add category </button></a>
        </div>
      </div>
    </div>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <div class="badge badge-success">{{ \App\Models\category::where('id',$category->parent_id)->value('title') }}</div>
                          @else
                          <div class="badge badge-danger">Not A sign</div>
                          @endif
                        </td>
                        <td><img src="{{$category->image }}" width="100%" height="50px" alt="{{ $category->title }}">
                          </th>
                        ...
                        <td style="width: 19%">
                          <ul class="m-0 list-inline">
                            ...
                            <li class="list-inline-item">
                              <form action="{{ route('deletcategories',$category->id) }}" method="post">
                                @csrf
                                <a href="" class="dltbtn">
                                  <button id="cancel-button" class="btn btn-danger btn-sm rounded-0" type="button"
