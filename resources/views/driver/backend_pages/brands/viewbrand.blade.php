    ...
    <div class="content-header row">
      ...
      <div class="content-header-right col-md-6 col-12">
        <div class=" float-md-right">
          <a href="{{ route('createbrand') }}"><button class="px-2 btn btn-primary round btn-glow" type="button" ><i class="la la-plus"></i> Add Brand </button></a>
        </div>
      </div>
    </div>
                ...
                <div class="card-body card-dashboard">
                  ...
                  <table class="table table-striped table-bordered file-export">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>{{ $brand->id }}</td>
                        <td><img src="{{asset($brand->image)  }}" width="100%" height="50px"
                            alt="{{ $brand->title }}"></th>
                        <td>{{ $brand->title }}</td>
                        <td>{{ $brand->slug }}</td>
                        ...
                        <td style="width: 19%">
                          <ul class="m-0 list-inline">
                            ...
                            <li class="list-inline-item">
                              <form action="{{ route('deletbrand',$brand->id) }}" method="post">
                              @csrf
                              <a href="" class="dltbtn">
