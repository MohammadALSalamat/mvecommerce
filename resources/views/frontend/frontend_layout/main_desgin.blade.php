                        ...
                        <div class="swiper-wrapper row cols-1 gutter-no">
                            <div class="swiper-slide">
                                <figure class="product-image">
                                    <img src="{{asset('front-style/assets/images/products/popup/1-440x494.jpg')}}"
                            ...
                            <div class="swiper-slide">
                                <figure class="product-image">
                                    <img src="{{asset('front-style/assets/images/products/popup/2-440x494.jpg')}}"
                                        data-zoom-image="{{asset('front-style/assets/images/products/popup/2-800x900.jpg')}}"
                                        alt="Water Boil Black Utensil" width="800" height="900">
                                </figure>
                            </div>
                            <div class="swiper-slide">
                                <figure class="product-image">
                                    <img src="{{asset('front-style/assets/images/products/popup/3-440x494.jpg')}}"
                                        data-zoom-image="{{asset('front-style/assets/images/products/popup/3-800x900.jpg')}}"
                                        alt="Water Boil Black Utensil" width="800" height="900">
                                </figure>
                            </div>
                            <div class="swiper-slide">
                                <figure class="product-image">
                                    <img src="{{asset('front-style/assets/images/products/popup/4-440x494.jpg')}}"
                                        data-zoom-image="{{asset('front-style/assets/images/products/popup/4-800x900.jpg')}}"
                                        alt="Water Boil Black Utensil" width="800" height="900">
                                </figure>
                            </div>
                        </div>
