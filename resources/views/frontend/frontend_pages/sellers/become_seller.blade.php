...
@section('mytitle','Become A Seller')

@else
@section('mytitle', 'كيف تصبح تاجر ')
        ...
        <div class="container create-store pb-1 pb-lg-10 mb-10">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 order-md-first">
                    ...
                    <h2 class="title text-left">Build your online store on ITAJER</h2>
        ...
        <div class="banner parallax mb-4" data-parallax-options="{'speed': 10, 'parallaxHeight': '200%', 'offset': -99}"
            ...
            <div class="container">
                <div class="banner-content text-center">
                    ...
                    <a href="{{ route('vendor_form') }}" class="btn btn-white btn-outline btn-rounded ls-25">Register Now</a>
                </div>
            </div>
        </div>
    </div>
...
<main class="main">
    ...
    <div class="container">
        <div class="page-header" style="background:url('/storage/photos/1/Artboard 1 copy-100.jpg');background-size:cover">
            <div class="container">
                <h1 class="page-title mb-0 text-white">كيف تصبح تاجر</h1>
            </div>
        </div>
    </div>
    <!-- End of Page Header -->
    ...
    <div class="page-content become-a-vendor">
        <div class="container create-store pb-1 pb-lg-10 mb-10">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 order-md-first">
                    <h4 class="text-primary font-weight-bold ls-25">عمل متجر </h4>
                    <h2 class="title text-left">قم ببناء متجرك الإلكتروني على اي تاجر</h2>
                    <p>من خلال اي تاجر يمكنك الان صنع موقعك الخاص هنا واخال منتجاتك لتبدأ بعدها ببيع المنتجات ووضع اسم في سوق البيع الالمتروني
                    </p>
                    <a href="{{ route('vendor_form') }}" class="btn btn-primery btn-outline btn-rounded ls-25">سجل الان</a>
        ...
        <div class="bg-grey how-trade pt-10 pb-5 pb-lg-10">
            <div class="container mt-2 mt-lg-10 mb-0 mb-lg-10">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 pl-lg-8">
                        <h4 class="text-primary font-weight-bold ls-25">كيفية التداول</h4>
                        <h2 class="title text-left">4 خطوات سهلة لإدارة بيع منتجاتك</h2>
                        <p class="mb-6">الخطوات الاساسية لعمليات البيع على متجرنا</p>
                        <div class="row cols-sm-2 mb-1">
                            <div class="stage-item mb-6 stage-register d-flex align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="Layer_4" x="0px" y="0px" width="70px" height="70px" viewBox="0 0 70 70" xml:space="preserve">
                                    <g>
                                ...
                                <p class="mb-0 font-weight-bold">تسجيل وأدخال المنتجات الخاصة بك</p>
                            </div>
                            <div class="stage-item mb-6 stage-selling d-flex align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="Layer_3" x="0px" y="0px" width="70px" height="70px" viewBox="0 0 70 70" xml:space="preserve">
                                    <g>
                                ...
                                <p class="mb-0 font-weight-bold">ابدأ ببيع منتجاتك</p>
                            </div>
                            <div class="stage-item mb-5 stage-deliver d-flex align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="Layer_1" x="0px" y="0px" width="70px" height="70px" viewBox="0 0 70 70" xml:space="preserve">
                                    <g id="Layer_5">
                                ...
                                <p class="mb-0 font-weight-bold">توصيل الى اي مكان داخل الامارات العربية المتحدة</p>
                            </div>
                            <div class="stage-item mb-5 stage-get d-flex align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="Layer_2" x="0px" y="0px" width="70px" height="70px" viewBox="0 0 70 70" xml:space="preserve">
                                    <g>
                                ...
                                <p class="mb-0 font-weight-bold">احصل على المدفوعات وزد دخلك</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container questions mt-2 mt-lg-10 mb-5 mb-lg-9">
            <h4 class="text-center text-primary font-weight-bold text-capitalize ls-25">أسئلة مكررة</h4>
            <h2 class="title title-center">اعثر على إجابة لسؤالك</h2>
            <div class="row">
                <div class="col-md-6">
                    <h4 class="font-weight-bold ls-25">كيف يمكنني إضافة منتجات جديدة؟</h4>
                    <p>يوفر متجرنا لوحة تحكم يستطيع البائع من خلالها اضافة جميع المنتجات التي يريدها وايضا يوجد داخل لوحة التحكم صفحة تعليمات لمساعدة البائع اذا صادف اي مشكلة</p>
                    <h4 class="font-weight-bold ls-25">كيف يمكنني معرفة المخزون؟</h4>
                    <p>من لوحة التحكم الخاصة بالبائعين يمكن معرفة كمية المخزون من المنتجات</p>
                </div>
                <div class="col-md-6">
                    <h4 class="font-weight-bold ls-25">كيف يتم الدفع لي؟</h4>
                    <p>يتم الدفع للبائعين عن طريق اتفاقيات بين المسؤولين الماليين والبائع  </p>
                    <h4 class="font-weight-bold ls-25">هل أحتاج إلى بطاقة ائتمان أو بطاقة خصم لإنشاء متجر؟</h4>
                    <p>التجار يحتاجون لدفع مبلغ مالي للاشتراك ويتم الاتفاق بين التاجر والمسؤولين قبل البدأ باي شيء </p>
                </div>
            </div>
        </div>
        <!-- End of Container -->
        ...
        <div class="banner parallax mb-4" data-parallax-options="{'speed': 10, 'parallaxHeight': '200%', 'offset': -99}"
            ...
            <div class="container">
                <div class="banner-content text-center">
                    <h2 class="title title-center text-white font-weight-bold">ابدأ  الان واجعل لعلامتك التجارية اسم في متجرنا </h2>
                    <a href="{{ route('vendor_form') }}" class="btn btn-white btn-outline btn-rounded ls-25">التسجيل للبائعين</a>
                </div>
            </div>
        </div>
    </div>
