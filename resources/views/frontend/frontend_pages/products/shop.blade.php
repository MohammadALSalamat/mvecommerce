                        ...
                        <div  style="height: auto !important" class="swiper-wrapper row gutter-lg cols-xl-8 cols-lg-7 cols-md-6 cols-sm-4 cols-xs-3 cols-2">
                            ...
                            <div class="swiper-slide category-wrap">
                                <div class="category category-ellipse">
                                    <figure class="category-media">
                                        <a href="shop-banner-sidebar.html">
                                            <img src="{{ asset('front-style/assets/images/categories/category-5.jpg') }}" alt="Categroy"
                            ...
                            <div class="swiper-slide category-wrap">
                                <div class="category category-ellipse">
                                    <figure class="category-media">
                                        <a href="shop-banner-sidebar.html">
                                            <img src="{{ asset('front-style/assets/images/categories/category-6.jpg') }}" alt="Categroy"
                            ...
                            <div class="swiper-slide category-wrap">
                                <div class="category category-ellipse">
                                    <figure class="category-media">
                                        <a href="shop-banner-sidebar.html">
                                            <img src="{{ asset('front-style/assets/images/categories/category-7.jpg') }}" alt="Categroy"
                            ...
                            <div class="swiper-slide category-wrap">
                                <div class="category category-ellipse">
                                    <figure class="category-media">
                                        <a href="shop-banner-sidebar.html">
                                            <img src="{{ asset('front-style/assets/images/categories/category-8.jpg') }}" alt="Categroy"
                            ...
                            <div class="swiper-slide category-wrap">
                                <div class="category category-ellipse">
                                    <figure class="category-media">
                                        <a href="shop-banner-sidebar.html">
                                            <img src="{{ asset('front-style/assets/images/categories/category-9.jpg') }}" alt="Categroy"
                            ...
                            <div class="swiper-slide category-wrap">
                                <div class="category category-ellipse">
                                    <figure class="category-media">
                                        <a href="shop-banner-sidebar.html">
                                            <img src="{{ asset('front-style/assets/images/categories/category-20.jp') }}g" alt="Categroy"
                            ...
                            <div class="swiper-slide category-wrap">
                                <div class="category category-ellipse">
                                    <figure class="category-media">
                                        <a href="shop-banner-sidebar.html">
                                            <img src="{{ asset('front-style/assets/images/categories/category-21.jp') }}g" alt="Categroy"
