    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="mb-2 content-header-left col-md-6 col-12 breadcrumb-new">
                <h3 class="mb-0 content-header-title d-inline-block">Edit Users</h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('view_coupon') }}">Home</a>
                            </li>
                            <li class="breadcrumb-item active"><a href="#">Edit Users</a>
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content collpase show">
                                <div class="card-body">
                                    ...
                                    <form class="form form-horizontal" action="{{ route('update_coupon',$current_coupon->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                       <div class="form-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" id="projectinput5" class="form-control"
                                                        placeholder="add the code" name="code" value="{{$current_coupon->code }}">
                                                </div>
                                            </div>
                                           <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <select id="projectinput6" name="type_of_coupon" class="form-control">
                                                        ...
                                                        <option value="fixed" @if ($current_coupon->type =='fixed') selected @endif>Fixed</option>
                                                        <option value="precentage" @if ($current_coupon->type =='precentage') selected @endif>Precentage</option>
                                                    </select>
                                                </div>
                                            </div>
                                             <div class="form-group row">
                                                <label class="col-md-3 label-control" for="projectinput1"> Value</label>
                                                <div class="col-md-9">
                                                    <input type="number" id="value" class="form-control"
                                                        placeholder="add value" name="value" value="{{ $current_coupon-> value}}">
                                                </div>
                                            </div>
                                             <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                   <!-- Rounded switch -->
                                                        <label class="switch">
                                                        <input type="checkbox" name="status" @if ($current_coupon->status == "1" ) checked @endif >
