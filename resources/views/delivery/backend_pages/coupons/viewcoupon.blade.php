    ...
    <div class="content-header row">
      ...
      <div class="content-header-right col-md-6 col-12">
        <div class=" float-md-right">
          <a href="{{ route('create_coupon') }}"><button class="px-2 btn btn-primary round btn-glow" type="button" ><i class="la la-plus"></i> Add Coupon </button></a>
        </div>
      </div>
    </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">View Coupons</h4>
                        ...
                        <td>
                              <span class="dropdown">
                                ...
                                <span aria-labelledby="btnSearchDrop2" class="mt-1 dropdown-menu dropdown-menu-right">
                                  <a href="{{ route('edit_coupon',$coupon->id) }}" class="dropdown-item"><i class="ft-edit-2"></i> Edit</a>
                                  <form action="{{ route('delet_coupon',$coupon->id) }}" method="post">
                                   @csrf
                                  <a href="" id="cancel-delete" data-id={{ $coupon->id }} class="dropdown-item dltbtn"><i class="ft-trash-2"></i> Delete</a>
                                  </form>                                  
                                </span>
                              </span>
                            </td>
