    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="mb-2 content-header-left col-md-6 col-12 breadcrumb-new">
                <h3 class="mb-0 content-header-title d-inline-block">Add shipping</h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('view_shipping') }}">Home</a>
                            </li>
                            <li class="breadcrumb-item active"><a href="#">Add shipping</a>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="horz-layout-basic">Add New shipping</h4>
                            ...
                            <div class="card-content collpase show">
                                <div class="card-body">
                                    ...
                                    <form class="form form-horizontal" action="{{ route('add_shipping') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" id="projectinput5" class="form-control"
                                                        placeholder="add the code" name="shipping_address" value="{{ old('shipping_adress') }}">
                                                </div>
                                            </div>
                                           <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="number" id="deliver_charge" class="form-control"
                                                        placeholder="add the code" name="deliver_charge" value="{{ old('deliver_charge') }}">
                                             ...
                                             <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" id="deliver_time" class="form-control"
                                                        placeholder="add value" name="deliver_time">
                                                </div>
                                            </div>
                                             <div class="form-group row">
